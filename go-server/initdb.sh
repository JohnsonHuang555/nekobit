...
psql --variable=ON_ERROR_STOP=1 --username "postgres" <<- EOSQL
    ...
    INSERT INTO game (name, game_pack, min_players, max_players, brief, description, img_url, estimate_time, created_at, updated_at) VALUES ('西洋棋', 'chess', 2, 2, '兩人對弈遊戲', '對弈起來', '/img/chess', 30, '2020-10-10', '2020-10-10');
EOSQL
