...
func (ru *roomUseCase) LeaveRoom(id string, userID string) ([]*domain.Player, error) {
...
func (ru *roomUseCase) ReadyGame(id string, userID string) ([]*domain.Player, error) {
...
func (ru *roomUseCase) ChooseCharacter(roomID string, userID string, characterID int) ([]*domain.Player, error) {
...
func (ru *roomUseCase) ChooseGroup(roomID string, userID string, group int) ([]*domain.Player, error) {
